...
final class xlsxwriterTests: XCTestCase {
    ...
    func testExample() {
        ...
        let ws1 = wb.addWorksheet(name: "Background")
        ws1.background("logo.png")
        let d1 = wb.addFormat().diagType(.up)
...
//  * Copyright 2014-2021, John McNamara, jmcnamara@cpan.org    
    func testHeadersAndFooters() {
        ...
        let ws7 = wb.addWorksheet(name: "Watermark")
        ws7.headerOpt("&C&[Picture]", imageCenter: "watermark.png")
        ws7.write("Select Print Preview to see the header and footer", "A1")
